...
curl --request GET \
 --url "${UBKG_URL}/concepts/C0006142/paths/subgraphs/sequential?relsequence=NCI:is_marked_by_gene_product&skip=X&limit=5" \
 --header "Accept: application/json" \
 --header "Authorization: UMLS-Key $umlskey" | tee -a test.out
echo | tee -a test.out
echo | tee -a test.out
...
curl --request GET \
 --url "${UBKG_URL}/concepts/C0006142/paths/subgraphs/sequential?relsequence=NCI:is_marked_by_gene_product&skip=0&limit=x" \
 --header "Accept: application/json" \
 --header "Authorization: UMLS-Key $umlskey" | tee -a test.out
echo | tee -a test.out
echo | tee -a test.out
...
curl --request GET \
 --url "${UBKG_URL}/concepts/C0006142/paths/subgraphs/sequential?relsequence=NCI%3Ais_marked_by_gene_product&skip=0&limit=-1" \
 --header "Accept: application/json" \
 --header "Authorization: UMLS-Key $umlskey" | tee -a test.out
echo | tee -a test.out
echo | tee -a test.out
...
curl --request GET \
 --url "${UBKG_URL}/concepts/C0006142X/paths/subgraphs/sequential?relsequence=NCI%3Ais_marked_by_gene_product,NCI%3Agene_product_encoded_by_gene&skip=0&limit=5" \
 --header "Accept: application/json" \
 --header "Authorization: UMLS-Key $umlskey" | tee -a test.out
echo | tee -a test.out
echo | tee -a test.out
...
curl --request GET \
 --url "${UBKG_URL}/concepts/C0006142/paths/subgraphs/sequential?relsequence=NCI%3Ais_marked_by_gene_product,NCI%3Agene_product_encoded_by_gene&skip=0&limit=5" \
 --header "Accept: application/json" \
 --header "Authorization: UMLS-Key $umlskey" | cut -c1-60 | tee -a test.out
echo | tee -a test.out
echo | tee -a test.out
...
curl --request GET \
 --url "${UBKG_URL}/concepts/C0006142/paths/subgraphs/sequential?relsequence=NCI%3Ais_marked_by_gene_product&relsequence=NCI%3Agene_product_encoded_by_gene&skip=0&limit=5" \
 --header "Authorization: UMLS-Key $umlskey" | cut -c1-60 | tee -a test.out
echo | tee -a test.out
echo | tee -a test.out
