...
from ..common_neo4j_logic import sab_code_count_get,sab_code_detail_get
...
def sabs_codes_counts_get():
    ...
    return sab_codes_counts_get()

@sabs_blueprint.route('/codes/counts/<sab>', methods=['GET'])
def sabs_codes_counts_sab_get(sab):
    # Return SAB and count of codes for specified SAB.
    return sab_codes_counts_get(sab)

def sab_codes_counts_get(sab=None):
...
@sabs_blueprint.route('/codes/details/<sab>', methods=['GET'])
def sab_codes_details_get(sab):
