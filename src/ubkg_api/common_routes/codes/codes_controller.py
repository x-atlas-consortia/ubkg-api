...
from ..neo4j_logic import codes_code_id_codes_get_logic, codes_code_id_concepts_get_logic
...
def codes_code_id_codes_get(code_id, sab=[]):
    ...
    return jsonify(codes_code_id_codes_get_logic(neo4j_instance, code_id, sab))
